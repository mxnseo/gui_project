...
def main(myWindow, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        myWindow.plot2(x_arr, to_numpy_valid, to_numpy_train)
...
def get_args_parser(folder_path2, epoch2, worker2 ,lr2,model2 ,weight2 ,device2,resultfolder_path2, batch_size, dataset, add_help=True):
    import argparse
    ...
    test_args2 = ["--data-path",folder_path2,"--epochs",str(epoch2),"--workers",str(worker2),"--lr",str(lr2),"--model", model2,"--weights-backbone",weight2,"--device",device2,"--output-dir",resultfolder_path2,
